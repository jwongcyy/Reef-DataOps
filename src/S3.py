...
class Storage:
    ...
    def set_default_region(cls, region_name):
        if Storage.recent_def_region:
            if Storage.recent_def_region[-1] != region_name:
                Storage.recent_def_region.pop()
                Storage.recent_def_region.append(region_name)
                # Execute the code
    ...
    def __init__(self, name, default_region='me-central-1'):
        Storage.set_default_region(default_region)
